...
$sql_check_auth = "SELECT autenticacao_habilitada, codigo_autenticacao FROM usuarios WHERE id=$userid";
$result_check_auth = $mysqli->query($sql_check_auth);
...
if ($result_check_auth->num_rows > 0) {
    ...
    if (!$codigo_autenticacao) {
        ...
        $sql_update = "UPDATE usuarios SET codigo_autenticacao='$codigo_autenticacao' WHERE id=$userid";
